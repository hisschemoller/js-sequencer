...
(function (WX) {
    ...
    SimpleOsc.prototype = Object.create(WH.PlugIn);
    ...
    SimpleOsc.prototype.defaultPreset = {
        oscType: 'sine',
        oscFreq: WX.mtof(60),
        lfoType: 'sine',
        lfoRate: 1.0,
    ...
    SimpleOsc.prototype.$oscType = function (value, time, rampType) {
      this._osc.type = value;
    };

    SimpleOsc.prototype.$oscFreq = function (value, time, rampType) {
      this._osc.frequency.set(value, time, rampType);
    };

    SimpleOsc.prototype.$lfoType = function (value, time, rampType) {
      this._lfo.type = value;
    };

    SimpleOsc.prototype.$lfoRate = function (value, time, rampType) {
      this._lfo.frequency.set(value, time, rampType);
    };

    SimpleOsc.prototype.$lfoDepth = function (value, time, rampType) {
     ...
     */
    SimpleOsc.prototype.noteOn = function (pitch, velocity, time) {
        time = (time || WX.now);
